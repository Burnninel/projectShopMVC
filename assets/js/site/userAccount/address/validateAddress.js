...
$('#btnSubmitAddress').click(function(event) {
    ...
    addErrorFormAccount('btnMap', 'checkboxAlterAddressCard', 'btnSearchCEP', 'svgSearchBtn');
    removeErrorFormAccount('btnMap', 'checkboxAlterAddressCard', 'btnSearchCEP', 'svgSearchBtn');
    keyupAddres();
});