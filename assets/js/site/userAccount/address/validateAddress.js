...
$('#btnSubmitAddress').click(function(event) {
    ...
    addErrorFormAccount('map', 'checkboxAlterAddressCard', 'btnSearchCEP', 'svgSearchBtn');
    removeErrorFormAccount('map', 'checkboxAlterAddressCard', 'btnSearchCEP', 'svgSearchBtn');
    keyupAddres();
});